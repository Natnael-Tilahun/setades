  ...
  return (
    <div className='flex justify-between items-center h-16 mx-auto px-4 md:px-10 text-black bg-[#fcd5d5]'>
      ...
      <ul className='hidden md:flex'>
        <li className='p-4 hover:text-slate-700'><Link to="/"> Home </Link></li>
        <li className='p-4 hover:text-slate-700'><Link to="../pages/product.jsx">Products</Link></li>
      </ul>
      ...
      <ul className={nav ? 'fixed left-0 top-0 w-[60%] h-full border-r border-r-gray-900 bg-[#fcd5d5] ease-in-out duration-500' : 'ease-in-out duration-500 fixed left-[-100%] text-black'}>
        <h1 className='w-full text-3xl font-bold text-[#00df9a] m-4'><img src="img.jpg" alt="" className='w-14 rounded-md' /></h1>
          <li className='p-4 border-b border-gray-600 hover:text-slate-700'><Link to="/">Home</Link></li>
          <li className='p-4 border-b border-gray-600 hover:text-slate-700'><Link to="/products">Procucts</Link></li>
